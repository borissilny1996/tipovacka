import { bd as ee, b_ as m$1, cT as y, bV as le, cR as wt, c6 as ne, aB as Ve, aJ as Xu, aE as Vl } from "./indexhtml-D1xuee7b.js";
import { b as b$1 } from "./state-BA6hnnsv-DRyppH94.js";
import { f } from "./query-BykXNUlT-DDC0EGul.js";
import { l } from "./base-panel-DwlRfMDt-DKRsjRcW.js";
import { o as o$1 } from "./icons-B1bSjv1h-o7ZGzefn.js";
import { i as i$1 } from "./overlay-monkeypatch-CMzG4ZpL-DTE0ZMGX.js";
...
var F = Object.defineProperty, T = Object.getOwnPropertyDescriptor, o = (e, t, n, l2) => {
  for (var a = l2 > 1 ? void 0 : l2 ? T(t, n) : t, p = e.length - 1, r; p >= 0; p--)
    (r = e[p]) && (a = (l2 ? r(t, n, a) : r(a)) || a);
  return l2 && a && F(t, n, a), a;
};
...
let i = class extends l {
    ...
    return this.message === void 0 ? ee`
          <div class="dialog-footer">
            <button
              ...
              @click="${() => {
      m$1.active ? y.emit("system-info-with-callback", {
  ...
  submit() {
    ...
    m$1.active ? y.emit("system-info-with-callback", {
      callback: (t) => ne(`${Ve}feedback`, { ...e, versions: t }),
      notify: false
    }) : ne(`${Ve}feedback`, { ...e, versions: {} }), this.parentNode?.style.setProperty("--section-height", "150px"), this.message = "Thank you for sharing feedback.";
  }
  keyDown(e) {
  ...
  openGithub(e, t) {
    ...
    const n = e ? e.replace(/\n/g, "%0A") : "Activate Copilot to include version info.", l2 = `${t.types.find((r) => r.value === this.type)?.ghTitle}`, a = t.description !== "" ? t.description : U, p = C.replace("{description}", a).replace("{versionsInfo}", n);
