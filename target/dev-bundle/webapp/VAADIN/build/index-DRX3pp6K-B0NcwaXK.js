import { ca as nu } from "./indexhtml-D1xuee7b.js";
var g, b;
function x() {
...
function E() {
  ...
  function d(n, t) {
    ...
    try {
      ...
      try {
        window.clipboardData.setData(t.format || "text", n), t.onCopy && t.onCopy(window.clipboardData), f = true;
      } catch (p) {
