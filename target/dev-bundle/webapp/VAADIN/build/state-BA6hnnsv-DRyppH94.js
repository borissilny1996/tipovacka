import { cX as yo, I as Hn } from "./indexhtml-D1xuee7b.js";
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const p = { attribute: true, type: String, converter: Hn, reflect: false, hasChanged: yo }, d = (t = p, n, e) => {
  const { kind: o, metadata: i } = e;
  let r = globalThis.litPropertyMetadata.get(i);
  if (r === void 0 && globalThis.litPropertyMetadata.set(i, r = /* @__PURE__ */ new Map()), o === "setter" && ((t = Object.create(t)).wrapped = true), r.set(e.name, t), o === "accessor") {
    const { name: a } = e;
    return { set(s) {
